...
PImage arrow, Black, arrow_black, Rectangle_Permanent1, Rectangle_Permanent2, Rectangle_Permanent3, startupimage1, startupimage2, startupimage3, rotatedimage1, rotatedimage2, rotatedimage3, cam3;
...
void setup() {
 ...
 //cam1 = new Capture(this, cameras[3]);//3
 //cam1.start();
 cam2 = new Capture(this, cameras[34]);//28
 cam2.start();
 cam1 = new Capture(this, cameras[36]);//72
 cam1.start();
