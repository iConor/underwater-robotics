...
byte port_thruster_servo_angle;
byte starboard_thruster_servo_angle;
byte port_thruster_motor_power;
byte starboard_thruster_motor_power;
byte aft_thruster_motor_power;
int check;
